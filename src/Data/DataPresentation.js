const Data_Presentation = [
    {
        id: 1,
        description: `Je suis ravie de vous accueillir ici, où vous pourrez découvrir mon parcours professionnel et mes réalisations. 
    
        Après plus de 20 ans dans le milieu médical, j’ai décidé de donner un nouveau souffle à ma vie professionnelle. J’ai entrepris des cours à distance afin de passer un BEP EPCV (Études de Projets de Communication Visuelle). Pendant cette formation, j’ai découvert des outils comme Photoshop, InDesign et Illustrator. J’ai réalisé deux petits projets personnels avec illustrator, que j’avais envie de partager avec vous.
    ...
    {
        id: 2,
        description: `Lors de ma formation en BEP EPCV, j’ai découvert Illustrator, un outil que j’ai adoré pour son côté à la fois créatif et structuré. Bien que je ne l’utilise plus aujourd’hui, cette expérience m’a permis de réaliser des cartes de Noël personnalisées pour mes enfants.
        
        Pour ces cartes, j’ai commencé par créer des personnages représentant notre famille (moi, mon fils et ma fille). Ensuite, j’ai intégré des personnages existants qui plaisent à mes enfants, comme Picsou, Totoro et un renne. J’ai également conçu des éléments décoratifs de Noël, tels que des sapins, des cadeaux et des boules de Noël, avant d’assembler le tout pour créer des cartes uniques.
    ...
    { id: 3, description:`Bienvenue dans la section consacrée à certains mes projets web. Tous ces sites sont responsives, conçus dans le cadre de projets personnels ou en équipe durant ma formation à la Wild Code Shool de Nantes. 

Pour mes projets personnels, j'ai réalisé moi-même les maquettes afin de structurer et visualiser les interfaces. Lors des travaux en groupe, nous avons également conçu nos propres maquettes en collaboration grâce à Figma, ce qui a permis une meilleure organisation et une vision claire de nos objectifs.

Les projets sont disponibles sur Github ou en ligne, et vous pouvez les consulter en cliquant sur les liens fournis.
...
export default Data_Presentation;
